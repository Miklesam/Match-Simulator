package com.miklesam.dotamatchsimulator.multipleer.host
...
class FragmentHost : Fragment(R.layout.fragment_host) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        hostViewModel.getToastMessage().observe(viewLifecycleOwner, Observer {
            Toast.makeText(context, it, Toast.LENGTH_LONG).show()
        })

        hostViewModel.getProgress().observe(viewLifecycleOwner, Observer {
            when (it) {
                0 -> {
